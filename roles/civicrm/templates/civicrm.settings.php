...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupaluser:drupal123@localhost/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicrmuser:civicrm123@localhost/civicrm?new_link=true');
  }
}
...
$civicrm_root = '{{drupal.project_root}}/{{drupal.project_domain}}/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '{{drupal.project_root}}/{{drupal.project_domain}}/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://{{drupal.project_domain}}');
}
 ...
 */
 ...
 $civicrm_setting['Directory Preferences']['extensionsDir'] = '/sites/default/custom_civivrm_extentions';
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '41f874a1dacdc4a152fb3213f2a1e730');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/drupal/mchavan.ml/sites/default/files/civicrm/templates_c/mail.log');
// }
